...
// NewPublicCloudConsumersGetParams creates a new PublicCloudConsumersGetParams object
// with the default values initialized.
func NewPublicCloudConsumersGetParams() *PublicCloudConsumersGetParams {
	var ()
	return &PublicCloudConsumersGetParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPublicCloudConsumersGetParamsWithTimeout creates a new PublicCloudConsumersGetParams object
...
// NewPublicCloudConsumersGetParamsWithContext creates a new PublicCloudConsumersGetParams object
...
// NewPublicCloudConsumersGetParamsWithHTTPClient creates a new PublicCloudConsumersGetParams object
...
/*PublicCloudConsumersGetParams contains all the parameters to send to the API endpoint
for the public cloud consumers get operation typically these are written to a http.Request
*/
...
func (o *PublicCloudConsumersGetParams) WithTimeout(timeout time.Duration) *PublicCloudConsumersGetParams {
...
func (o *PublicCloudConsumersGetParams) WithContext(ctx context.Context) *PublicCloudConsumersGetParams {
	o.SetContext(ctx)
	return o
}
...
func (o *PublicCloudConsumersGetParams) WithHTTPClient(client *http.Client) *PublicCloudConsumersGetParams {
...
func (o *PublicCloudConsumersGetParams) WithXAuthToken(xAuthToken string) *PublicCloudConsumersGetParams {
...
func (o *PublicCloudConsumersGetParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
