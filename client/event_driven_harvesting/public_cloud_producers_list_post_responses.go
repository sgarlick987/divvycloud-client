...
func (o *PublicCloudProducersListPostReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPublicCloudProducersListPostOK()
...
func NewPublicCloudProducersListPostOK() *PublicCloudProducersListPostOK {
	return &PublicCloudProducersListPostOK{}
}
...
func (o *PublicCloudProducersListPostOK) Error() string {
	return fmt.Sprintf("[POST /public/cloud/producers/list][%d] publicCloudProducersListPostOK ", 200)
}

func (o *PublicCloudProducersListPostOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
