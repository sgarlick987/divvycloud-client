...
// CreateneworganizationRequest CreateneworganizationRequest
// swagger:model CreateneworganizationRequest
...
func (m *CreateneworganizationRequest) validateOrganizationName(formats strfmt.Registry) error {
...
func (m *CreateneworganizationRequest) UnmarshalBinary(b []byte) error {
	var res CreateneworganizationRequest
